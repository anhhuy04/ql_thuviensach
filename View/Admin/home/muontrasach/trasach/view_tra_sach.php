                ...
                <table class="table text-center table-hover mt-4 table-bordered table-striped">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr >
                            ...
                            <td><div class="hang1_table" style="min-width: 50px;"><span style="min-width: 120px;" class="btn <?=$select_MuonSach["TrangThai"]=="Đã trả"?"btn-success":"btn-danger"?>"><?=$select_MuonSach["TrangThai"]?></span></div></td>                
                            <td><div class="hang1_table" style="min-width: 50px;"><button class="btn btn-primary">Xem</button></div></td>
                        </tr>
