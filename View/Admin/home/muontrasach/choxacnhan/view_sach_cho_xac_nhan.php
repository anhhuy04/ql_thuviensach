            ...
            <table class="table text-center table-hover mt-4 table-bordered table-striped">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td><div class="hang1_table" style="min-width: 50px;"><span style="min-width: 120px;" class="btn btn-warning"><?=$select_MuonSach["TrangThai"]?></span></div></td>
                        <td>
                            <div class="hang1_table" style="min-width: 50px;">
                                <a class="btn btn-primary" href="<?=$base_url_admin?>ql_muon_sach/detail_muon_sach?mamuonsach=<?=$select_MuonSach['MaMuonSach']?>">Xác nhận</a>
                            </div>
                        </td>
                    </tr>
                    <?php $stt++; endforeach; ?>
