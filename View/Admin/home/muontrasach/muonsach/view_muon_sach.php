            ...
            <div class="table-responsive">
                ...
                <table class="table text-center table-hover mt-4 table-bordered table-striped">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        ?>
                        <tr onclick="window.location.href='<?=$base_url_admin?>ql_muon_sach/detail_view?mamuonsach=<?=$select_MuonSach["MaMuonSach"]?>'">
                            ...
                            <td><div class="hang1_table" style="min-width: 50px;"><span style="min-width: 120px;" 
                            class="btn <?=$select_MuonSach["TrangThai"]=="Đã trả"?"btn-success":($select_MuonSach["TrangThai"]=="Đang mượn"?"btn-danger":"btn-warning")?>"><?=$select_MuonSach["TrangThai"]?></span></div></td>                
                            <td>
                                <div class="hang1_table" style="min-width: 50px;">
                                    <a class="btn btn-primary" href="<?=$base_url_admin?>ql_muon_sach/tra_sach?mamuonsach=<?=$select_MuonSach["MaMuonSach"]?>">Trả sách</a>
                                    <!-- <a class="btn btn-info" href="<?=$base_url_admin?>ql_muon_sach/detail_muon_sach?mamuonsach=<?=$select_MuonSach["MaMuonSach"]?>">Chi tiết</a> -->
                                    <?php if ($select_MuonSach["TrangThai"] == "Đang mượn"): ?>
                                        <a class="btn btn-warning" href="<?=$base_url_admin?>ql_muon_sach/detail_giahan?mamuonsach=<?=$select_MuonSach["MaMuonSach"]?>">Gia hạn</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>      
